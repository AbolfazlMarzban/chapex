<template>
    <v-col @click.stop="$emit('select',element)" class=" mb-1" :class="selectedClass()" :cols="element.TFF_FColumn">
        ...
        <FormField :element="element" :value="value" :isadmin="isadmin"></FormField>    
...
export default {
    ...
    props: ["element", "readonly", "selected","value" , "isadmin"],
    ...
    methods: {
        editedField(element) {
            ...
            else if(element.type == "advUploader"){
